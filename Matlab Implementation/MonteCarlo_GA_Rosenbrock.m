...
%  Algoritma : GA (Genetic Algorithm)
%  Benchmark : Logaritmik Rosenbrock
%
%  Bu betik GA.m fonksiyonunu N_runs kez bagimsiz olarak calistirir.
...
%  GEREKLI: GA.m ayni klasorde bulunmalidir.
% =====================================================================
...
% --- Monte Carlo dongusu ---
fprintf('=== Monte Carlo: GA / Logaritmik Rosenbrock ===\n');
...
for k = 1:N_runs
    ...
    [~, bf, bp] = evalc('GA(obj_func, lower_bound, upper_bound, num_vars, pop_size, max_iter, crossover_rate, mutation_rate)');
    fits(k) = bf;
    positions(k, :) = bp;
end
...
% --- Sonuc raporu ---
fprintf('\n--------------------------------------------------\n');
fprintf(' SONUCLAR (GA / Logaritmik Rosenbrock, N = %d)\n', N_runs);
fprintf('--------------------------------------------------\n');
...
figure('Name', 'Monte Carlo - GA / Logaritmik Rosenbrock', 'Color', 'w', ...
...
title(sprintf('GA / Logaritmik Rosenbrock  |  ort=%.4g, std=%.4g  (N=%d)', ...
