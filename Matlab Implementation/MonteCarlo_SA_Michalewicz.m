...
% --- Monte Carlo dongusu ---
fprintf('=== Monte Carlo: SA / Michalewicz ===\n');
...
% --- Sonuc raporu ---
fprintf('\n--------------------------------------------------\n');
fprintf(' SONUCLAR (SA / Michalewicz, N = %d)\n', N_runs);
fprintf('--------------------------------------------------\n');
...
figure('Name', 'Monte Carlo - SA / Michalewicz', 'Color', 'w', ...
...
title(sprintf('SA / Michalewicz  |  ort=%.4g, std=%.4g  (N=%d)', ...
