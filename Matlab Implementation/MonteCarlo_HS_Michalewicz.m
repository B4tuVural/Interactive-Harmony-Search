...
% --- Monte Carlo dongusu ---
fprintf('=== Monte Carlo: HS / Michalewicz ===\n');
...
% --- Sonuc raporu ---
fprintf('\n--------------------------------------------------\n');
fprintf(' SONUCLAR (HS / Michalewicz, N = %d)\n', N_runs);
fprintf('--------------------------------------------------\n');
...
figure('Name', 'Monte Carlo - HS / Michalewicz', 'Color', 'w', ...
...
title(sprintf('HS / Michalewicz  |  ort=%.4g, std=%.4g  (N=%d)', mean_fit, std_fit, N_runs));
