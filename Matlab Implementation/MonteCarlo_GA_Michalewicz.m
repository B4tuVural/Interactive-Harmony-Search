...
% --- Monte Carlo dongusu ---
fprintf('=== Monte Carlo: GA / Michalewicz ===\n');
...
% --- Sonuc raporu ---
fprintf('\n--------------------------------------------------\n');
fprintf(' SONUCLAR (GA / Michalewicz, N = %d)\n', N_runs);
fprintf('--------------------------------------------------\n');
...
figure('Name', 'Monte Carlo - GA / Michalewicz', 'Color', 'w', ...
...
title(sprintf('GA / Michalewicz  |  ort=%.4g, std=%.4g  (N=%d)', ...
